              ...
              {(currentPageName === 'Dashboard' || currentPageName === 'AccountsArchive' || currentPageName === 'ArchiveAccounts' || currentPageName === 'ContactsArchive' || currentPageName === 'ArchiveCaseDetails' || currentPageName === 'ModulesManager' || currentPageName === 'Management' || currentPageName === 'Marketing' || currentPageName === 'ModuleView' || currentPageName === 'ModuleArchive' || currentPageName === 'RecordsTable') && (
                <>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start" className="w-[140px] p-2 space-y-5 animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 duration-200">
                      <Link to={createPageUrl('Dashboard')}>
                        <DropdownMenuItem className="px-1.5 py-2.5 cursor-pointer bg-green-50 border-2 border-green-200 hover:border-green-400 hover:bg-green-100 rounded-lg transition-all">
                      ...
                      <Link to={createPageUrl('RecordsTable')}>
                        <DropdownMenuItem className="px-1.5 py-2.5 cursor-pointer bg-teal-50 border-2 border-teal-200 hover:border-teal-400 hover:bg-teal-100 rounded-lg transition-all">
                          <div className="flex items-center gap-2 justify-end w-full">
                  ...
                  {currentPageName === 'ArchiveAccounts' && (
                    <>
                      ...
                      <div className="relative w-64">
                        ...
                        <Input
                          placeholder="חיפוש..."
                          value={typeof window !== 'undefined' ? window.archiveAccountsSearchTerm || '' : ''}
                          onChange={(e) => {
                            if (typeof window !== 'undefined' && window.setArchiveAccountsSearchTerm) {
                              window.setArchiveAccountsSearchTerm(e.target.value);
                            }
                          }}
                          className="pr-10"
                        />
