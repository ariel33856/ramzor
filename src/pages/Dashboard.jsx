                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className={`p-0.5 rounded border-2 transition-colors flex flex-col ${sortField === fieldId ? 'bg-blue-100 border-blue-400' : 'hover:bg-gray-100 border-gray-300'}`}
                              title={sortField === fieldId && sortDirection === 'desc' ? 'מיין בסדר עולה' : 'מיין בסדר יורד'}
                            >
                              <ArrowUp className={`w-4 h-4 -mb-1 ${sortField === fieldId && sortDirection === 'asc' ? 'text-blue-600' : 'text-gray-400'}`} />
