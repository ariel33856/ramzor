                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className={`p-0.25 rounded border-2 transition-colors flex items-center gap-0 ${sortField === fieldId ? 'bg-blue-100 border-blue-400' : 'hover:bg-gray-100 border-gray-300'}`}
