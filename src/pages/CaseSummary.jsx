  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      <div className="max-w-7xl mx-auto p-6">
        <div className="bg-white rounded-2xl border-2 border-purple-200 p-8 shadow-lg bg-purple-50 bg-opacity-30">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">תקציר התיק</h2>
          </div>
