                    ...
                    <React.Fragment key={`couple-${contact.id}-${partner.id}`}>
                      <div className="flex items-center gap-1">
                        <div className="flex flex-col items-center">
                          ...
                          <div className={`w-full h-[6px] rounded-full transition-all duration-300 ${activeContactId === contact.id ? 'bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 shadow-[0_0_8px_2px_rgba(59,130,246,0.5)]' : 'bg-transparent'}`} />
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <div className={`w-full h-[6px] rounded-full transition-all duration-300 ${activeContactId === partner.id ? 'bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 shadow-[0_0_8px_2px_rgba(59,130,246,0.5)]' : 'bg-transparent'}`} />
                        </div>
                      </div>
                      ...
                      {allContacts
                        ...
                        .map(contact => (
                          <div
                            ...
                            onClick={async () => {
                              console.log('Linking contact:', contact.id);
                              try {
