          ...
          <div className="grid grid-cols-4 gap-6">
            ...
            <div className="border-2 border-blue-400 rounded-xl p-4 bg-blue-200 shadow-sm">
              ...
              <div className="space-y-3">
                {tabs.filter(tab => ['personal', 'contact', 'contacts', 'summary', 'tracking'].includes(tab.id)).map((tab) => {
                  const Icon = tab.icon;
            ...
            <div className="border-2 border-purple-400 rounded-xl p-4 bg-purple-200 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                {tabs.filter(tab => ['notes', 'property', 'data', 'status', 'workflow', 'calendar', 'documents', 'submissions'].includes(tab.id)).map((tab) => {
                  const Icon = tab.icon;
                  const isActive = activeTab === tab.id;
                  return (
                    <motion.button
            ...
            <div className="border-2 border-orange-400 rounded-xl p-4 bg-orange-200 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                {tabs.filter(tab => ['calculator', 'payments', 'insurance', 'products'].includes(tab.id)).map((tab) => {
                  const Icon = tab.icon;
                  const isActive = activeTab === tab.id;
                  return (
                    <motion.button
