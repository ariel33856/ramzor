...
import { NI, AmountInputC } from "./CalcInputs";
...
function MortgageDashboard({ isDark, setIsDark, startEmpty, initialData, onSave }) {
  ...
  const profileRows = [
    ...
    {label:"מספר לווים",color:K.teal,input:true,el:<NI inpS={inpS} value={numBorrowers} onChange={setNumBorrowers} min={1} max={4} step={1} style={{width:44}}/>},
