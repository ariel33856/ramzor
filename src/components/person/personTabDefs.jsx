...
// Shared tab definitions used by both PersonDetailsView and ContactsSummaryView
...
const personTabDefs = [
  ...
  { id: 'income', label: 'הכנסות', activeBg: 'bg-olive-50', activeText: 'text-olive-700', borderColor: 'border-olive-400', bottomBorderColor: 'border-b-olive-400' },
